...
export function ParameterPanel({
  ...
  const nutBolts = (horizontalStructure220cm + horizontalStructure140cm + verticalStructure220cm + verticalStructure140cm + u + t) * 16 * 2 + (horizontalPlus + verticalPlus) * 8 * 2
